...
SELECT cursus, code ,begindatum
FROM uitvoeringen, cursussen
...
VALUES ('S02','02-03-2024','7369','LEERDAM')
...
VALUES (8030,'cecilio','c','VERKOPER',7902,'28-04-2002',900,200,30)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
INSERT INTO uitvoeringen(cursus, begindatum, docent, locatie)
VALUES ('D&P','09-02-2001', '7902','Leerdam')
ON CONFLICT DO NOTHING;
INSERT INTO uitvoeringen(cursus, begindatum, docent, locatie)
VALUES ('D&P','09-02-2002','7902','Leerdam')
ON CONFLICT DO NOTHING;
INSERT INTO inschrijvingen(cursist, cursus, begindatum, evaluatie)
VALUES  (7934,'D&P','09-02-2001',4)
ON CONFLICT DO NOTHING;
INSERT INTO inschrijvingen(cursist, cursus, begindatum, evaluatie)
VALUES  (7934,'D&P','09-02-2001',4)
ON CONFLICT DO NOTHING;
INSERT INTO inschrijvingen(cursist, cursus, begindatum, evaluatie)
VALUES  (7934,'D&P','09-02-2002',4)
ON CONFLICT DO NOTHING;
...
WHERE functie = 'VERKOPER' AND functie != 'MANAGER';
...
VALUES (50,'FINANCIEN','LEERDAM',7782)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]

INSERT INTO medewerkers(MNR, NAAM, VOORL, FUNCTIE, CHEF, GBDATUM, MAANDSAL, COMM, AFD)
VALUES (8000,'Sly','S','TRAINER',7782,'04-09-2003,5000',500,300,50)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
